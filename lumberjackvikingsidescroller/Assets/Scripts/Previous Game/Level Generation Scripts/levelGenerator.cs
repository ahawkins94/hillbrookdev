...
public class levelGenerator : MonoBehaviour {
	...
	void Start () {
		...
		prefabName.Clear ();
                ...
                //Creates the first block in a position, could add ability to set which block
		GameObject start = Instantiate (Resources.Load ("Prefabs/StartBlock"), 
